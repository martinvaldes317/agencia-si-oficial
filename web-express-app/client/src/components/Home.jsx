...
export default function Home() {
    ...
    return (
        <div className="antialiased overflow-x-hidden" style={{ background: T.white, color: T.black, fontFamily: 'Poppins, sans-serif' }}>
            ...
            <a href="https://wa.me/56932930812?text=Hola%2C%20quiero%20contacto%20directo%20con%20AgenciaSi"
                target="_blank" rel="noopener noreferrer"
                className="fixed bottom-6 left-6 z-50 flex items-center gap-3 px-4 py-3 rounded-full shadow-lg group transition-all hover:scale-105"
                ...
                <span className="text-white text-sm font-semibold whitespace-nowrap">Contacto directo</span>
            </a>
            <Helmet>
