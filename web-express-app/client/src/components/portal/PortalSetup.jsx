...
export default function PortalSetup() {
  ...
  const submit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await fetch(`${API}/api/auth/client/setup-password`, {
        method: 'POST',
      ...
      else setError(d.message || 'El enlace no es válido o ya expiró')
    } catch {
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white font-semibold text-lg mt-3">Crea tu contraseña</p>
          <p className="text-zinc-500 text-sm mt-1">Para acceder a tu portal de cliente</p>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
          {success ? (
            <div className="text-center space-y-4">
              <p className="text-green-400 text-lg font-semibold">✓ Contraseña creada</p>
