// División político-administrativa de Chile: 16 regiones y sus comunas.
...
export function comunasDeRegion(regionNombre) {
  return CHILE_REGIONES.find(r => r.region === regionNombre)?.comunas || []
}
